...
module.exports = {
  ...
  systemName: 'BODE',              //系统名称
  copyright: 'MADE BY YLX',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://blog.csdn.net/YXXXYX?type=blog', name: 'CSDN'},
    {link: 'https://github.com/xxxx-nobug', icon: 'github'},
    {link: 'https://gitee.com/yxxxyx', name: 'gitee'}
  ],
}
